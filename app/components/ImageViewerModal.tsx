...
export function ImageViewerModal({ open, onClose, imageUrl, imageName }: ImageViewerModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-[90vw] max-h-[90vh] bg-[#1e1f22] border-none p-0 overflow-hidden" aria-describedby={undefined}>
        <VisuallyHidden>
